...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640575116
...
export QT_AUTO_SCREEN_SCALE_FACTOR=1
## altflags1 end
%make_install -- LV2_UI=0 VST_UI=0 BUILD_R3D_BACKENDS="" BUILD_MODULES="ladspa lv2" PREFIX=/usr LIB_PATH="/usr/lib64" SHELL="/bin/bash -x" V=1 VERBOSE=1
